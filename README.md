...
Projeto desenvolvido como teste técnico para processo seletivo de estágio. Trata-se de uma aplicação full stack simples para cadastro, listagem e exclusão de produtos, com backend em Node.js/Express e frontend em HTML, CSS e JavaScript puro, totalmente integrados via requisições HTTP.
...
Com o backend rodando, abra o arquivo que está na pasta frontend `index.html` diretamente no navegador, ou utilize a extensão **Live Server** do VS Code para uma experiência mais fluida.
